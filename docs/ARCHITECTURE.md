...
Backline composes capability primitives instead of a monolithic build.
...
- Capability modules included: `tokenization`, `payments`

## Smart contracts (Stellar / Soroban)
- Network: Stellar testnet
- Modules composed in this build: `token`, `payments`
